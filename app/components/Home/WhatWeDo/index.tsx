...
const WhatWeDo = () => {
  return (
    <section className="w-full bg-[#4A3E00] rounded-2xl mt-8 sm:mt-12 lg:mt-16">
      {/* Inner Container - matches stats section padding */}
      <div className="mx-auto px-4 sm:px-6 lg:px-6">
        <div className="p-4 lg:p-10">
          {/* Header */}
          <div className="text-center mb-8 sm:mb-10 lg:mb-12">
            <span className="inline-block bg-[#FFD908] text-[#4A3E00] font-bold text-sm sm:text-base tracking-widest px-8 sm:px-12 py-3 rounded-md mb-6">
              WHAT WE DO
            </span>
          ...
          <div className="overflow-hidden rounded-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              {/* Content */}
              <div className="bg-[#fffdf3] p-8 sm:p-10 lg:p-12 flex flex-col justify-center md:rounded-tr-3xl h-[250px] sm:h-[280px] md:h-[300px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              {/* Content */}
              <div className="bg-[#fffdf3] p-8 sm:p-10 lg:p-12 flex flex-col justify-center order-2 md:order-1 md:rounded-bl-3xl h-[250px] sm:h-[280px] md:h-[300px]">
                <h3 className="text-lg sm:text-xl lg:text-[22px] font-bold text-[#4A3E00] mb-3 sm:mb-4 text-center md:text-left">
